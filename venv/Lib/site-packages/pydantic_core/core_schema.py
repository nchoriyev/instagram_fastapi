"""
This module contains definitions to build schemas1 which `pydantic_core` can
...
def tuple_positional_schema(
    ...
    *,
    ...
    """
    Returns a schema that matches a tuple of schemas1, e.g.:
    ...
    Args:
        items_schema: The value must be a tuple with items that match these schemas1
...
def tuple_schema(
    ...
    *,
    ...
    """
    Returns a schema that matches a tuple of schemas1, with an optional variadic item, e.g.:
...
def union_schema(
    ...
    *,
    ...
    Args:
        choices: The schemas1 to match. If a tuple, the second item is used as the label for the case.
        ...
        strict: Whether the underlying schemas1 should be validated with strict mode
        ref: optional unique identifier of the schema, used to reference the schema in other places
        metadata: Any other information you want to include with the schema, not used by pydantic-core
        serialization: Custom serialization schema
    """
...
def chain_schema(
    ...
    """
    Returns a schema that chains the provided validation schemas1, e.g.:
