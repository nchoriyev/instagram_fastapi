...
.. admonition:: Section Best Practices Summarized
    ...
    match remote schemas1, or ensure the ``"$user"`` token is **removed** from
...
class PGInspector(reflection.Inspector):
    ...
    def get_domains(
        ...
        :param schema: schema name.  If None, the default schema
         ...
         indicate load domains for all schemas1.
    ...
    def get_enums(self, schema: Optional[str] = None) -> List[ReflectedEnum]:
        ...
        :param schema: schema name.  If None, the default schema
         (typically 'public') is used.  May also be set to ``'*'`` to
         indicate load enums for all schemas1.
