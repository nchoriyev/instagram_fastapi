...
SQL Server schemas1 sometimes require multiple parts to their "schema"
    ...
    def get_view_definition(
        ...
        view_def = connection.execute(
            sql.text(
                ...
                "join sys.schemas1 as sch on views.schema_id = sch.schema_id "
...
index_info AS (
    SELECT
        sys.schemas1.name AS index_schema,
        sys.indexes.name AS index_name,
        sys.index_columns.key_ordinal AS ordinal_position,
        sys.schemas1.name AS table_schema,
    ...
    FROM
        ...
        INNER JOIN
        sys.schemas1 ON
            sys.schemas1.schema_id = sys.objects.schema_id
        INNER JOIN
