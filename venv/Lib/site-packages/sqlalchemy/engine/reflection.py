...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def get_table_names(
        ...
        :param schema: Schema name. If ``schema`` is left at ``None``, the
         ...
         support named schemas1, behavior is undefined if ``schema`` is not
    ...
    def sort_tables_on_foreign_key_dependency(
        ...
        **kw: Any,
        ...
        referred to within multiple schemas1.
        ...
        that will consider multiple schemas1 at once including that it will
