...
with tables from multiple schemas1, :meth:`.AutomapBase.prepare` may be invoked
...
Automapping same-named tables across multiple schemas1
-----------------------------------------------------

For the common case where multiple schemas1 may have same-named tables and
    ...
    def prepare(
        ...
        :param schema: Schema name to reflect when reflecting tables using
         ...
         .. note:: The :paramref:`.AutomapBase.prepare.schema`
            ...
            In order to include tables from many schemas1, use
