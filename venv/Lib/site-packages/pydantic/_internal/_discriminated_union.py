...
class _ApplyInferredDiscriminator:
    ...
    * Handling various edge cases such as 'definitions', 'default', 'nullable' schemas1, and more
    ...
    def __init__(self, discriminator: str, definitions: dict[str, core_schema.CoreSchema]):
        ...
        # `definitions` should contain a mapping of schema ref to schema for all schemas1 which might
        ...
        # to the possible presence of other wrapper schemas1 such as DefinitionsSchema, WithDefaultSchema, etc.
    ...
    def _apply_to_root(self, schema: core_schema.CoreSchema) -> core_schema.CoreSchema:
        ...
        unwrapping nullable or definitions schemas1, and calling the `_handle_choice`
    ...
    def _handle_choice(self, choice: core_schema.CoreSchema) -> None:
        ...
        * Tracking the presence of 'none' and 'nullable' schemas1 occurring as choices
