...
def modify_model_json_schema(
    ...
    *,
    ...
    # Preserve the fact that definitions schemas1 should never have sibling keys:
...
class GenerateSchema:
    ...
    def _add_js_function(self, metadata_schema: CoreSchema, js_function: Callable[..., Any]) -> None:
        ...
        # because of how we generate core schemas1 for nested generic models
    ...
    def _unpack_refs_defs(self, schema: CoreSchema) -> CoreSchema:
        """Unpack all 'definitions' schemas1 into `GenerateSchema.defs.definitions`
    ...
    def match_type(self, obj: Any) -> core_schema.CoreSchema:  # noqa: C901
        """Main mapping of types to schemas1.
    ...
    def _apply_single_annotation(self, schema: core_schema.CoreSchema, metadata: Any) -> core_schema.CoreSchema:
        ...
        if schema['type'] == 'nullable':
            # for nullable schemas1, metadata is automatically applied to the inner schema
